...
public class HzKernelLoggerFactoryTest extends Assert {

	private HzKernelLoggerFactory factory;
	
	@Before
	public void setUp() {
		this.factory = new HzKernelLoggerFactory();
	}
	...
	public void getLogService() {
		assertNull(HzKernelLoggerFactory.getLogService());
	}
	
	@Test
	public void setLogService() {
		LogService serv = Mockito.mock(LogService.class);
		HzKernelLoggerFactory.setLogService(serv);
		assertSame(serv, HzKernelLoggerFactory.getLogService());
	}
