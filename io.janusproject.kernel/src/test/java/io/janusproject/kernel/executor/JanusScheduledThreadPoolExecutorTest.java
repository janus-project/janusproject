...
import io.janusproject.FutureExceptionMatcher;
...
public class JanusScheduledThreadPoolExecutorTest extends Assert {

	static final Object VALUE = new Object();

	private TerminationListener termListener;
	private JanusScheduledThreadPoolExecutor executor;
	...
	public void setUp() {
		...
		this.executor = new JanusScheduledThreadPoolExecutor(new JanusThreadFactory(this.handler));
	 ...
	 * @mavenartifactid $ArtifactId$
	 */
	private static class TerminationListener implements TaskListener {
