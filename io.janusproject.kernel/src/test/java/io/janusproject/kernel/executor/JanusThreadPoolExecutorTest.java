...
public class JanusThreadPoolExecutorTest extends Assert {

	static final Object VALUE = new Object();

	private TerminationListener termListener;
	private JanusThreadPoolExecutor executor;
	...
	public void setUp() {
		...
		this.executor = new JanusThreadPoolExecutor(new JanusThreadFactory(this.handler));
