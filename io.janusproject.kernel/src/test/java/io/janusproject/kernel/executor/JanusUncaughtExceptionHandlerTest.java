...
public class JanusUncaughtExceptionHandlerTest extends Assert {

	private LogService logger;
	private JanusUncaughtExceptionHandler handler;
	...
	public void setUp() {
		...
		this.handler = new JanusUncaughtExceptionHandler(this.logger);
	}
	...
	public void uncaughtException_Exception() {
		...
		assertEquals("io.janusproject.kernel.executor.JanusUncaughtExceptionHandlerTest", argument.getValue().getSourceClassName()); //$NON-NLS-1$
