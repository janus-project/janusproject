...
public class NewNameLoggingSkillTest extends Assert {
	...
	public void setUp() throws Exception {
		...
		this.owner = new Agent(agentId) {
			...
			protected <S extends Capacity> S getSkill(Class<S> capacity) {
				return capacity.cast(NewNameLoggingSkillTest.this.skill);
			}
		};
		...
		this.skill.install();
		//
		this.newName = UUID.randomUUID().toString();
		this.skill.setLoggingName(this.newName);
		//
	...
	public void errorObject_off() {
		...
		Mockito.verify(this.parentLogger, Mockito.times(2)).getLevel();
