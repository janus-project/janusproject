...
public class BaseSpawnServiceTest extends Assert {
	...
	@InjectMocks
	private BaseSpawnService spawnService;
		...
		this.agent = Mockito.spy(new Agent(UUID.randomUUID()) {
			...
			protected <S extends Capacity> S getSkill(Class<S> capacity) {
				if (ExternalContextAccess.class.equals(capacity))
					return capacity.cast(BaseSpawnServiceTest.this.contextAccess);
				return capacity.cast(BaseSpawnServiceTest.this.innerAccess);
			}
		});
