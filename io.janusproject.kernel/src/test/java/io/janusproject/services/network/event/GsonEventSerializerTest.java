...
//		}
	...
	public void deserialize() throws Exception {
		...
		realHeaders.put("x-java-event-class", "io.janusproject.services.network.event.GsonEventSerializerTest$EventMock");  //$NON-NLS-1$//$NON-NLS-2$
		realHeaders.put("x-java-scope-class", "io.janusproject.services.network.event.GsonEventSerializerTest$ScopeMock");  //$NON-NLS-1$//$NON-NLS-2$
