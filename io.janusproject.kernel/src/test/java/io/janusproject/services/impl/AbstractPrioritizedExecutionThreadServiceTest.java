...
public class AbstractPrioritizedExecutionThreadServiceTest extends Assert {

	private AbstractPrioritizedExecutionThreadService service;
	
	@Before
	public void setUp() {
		this.service = new AbstractPrioritizedExecutionThreadService() {
			@Override
