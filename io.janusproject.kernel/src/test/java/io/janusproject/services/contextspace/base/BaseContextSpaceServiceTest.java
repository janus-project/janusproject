...
public class BaseContextSpaceServiceTest extends Assert {
	...
	private BaseContextSpaceService service;
	...
	public void setUp() {
		...
		this.service = new BaseContextSpaceService();
	...
	public void twoStepConstruction() throws Exception {
		TwoStepConstruction annotation = BaseContextSpaceService.class.getAnnotation(TwoStepConstruction.class);
		assertNotNull(annotation);
		for(String name : annotation.names()) {
			for(Method method : BaseContextSpaceService.class.getMethods()) {
