 ...
 */
public interface KernelDiscoveryService extends JanusService {
	...
	/** Replies the URIs of the other kernels.
	 * 
	 * @return the uri of the other kernels.
	 */
	public Set<URI> getRemoteKernels();

	/** Replies the URIs of the kernels, including the current kernels.
	 * 
	 * @return the uri of the kernels.
	 */
	public Set<URI> getKernels();
