 ...
 */
public interface ExecutorService extends JanusService {
     ...
     * + 2 * period, and so on. If any execution of the task encounters an
	...
	/** Remove all the pending tasks, and try to stop the running tasks.
	 */
