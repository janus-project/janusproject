 ...
 */
package io.janusproject2.kernel.hazelcast;
...
//	}
	...
	@Override
	public <K, V> io.janusproject2.repository.MultiMap<K, V> getMultiMap(String name) {
	 ...
	 * @param <V>
	 */
	private static final class MultiMapWrapper<K,V> implements io.janusproject2.repository.MultiMap<K,V> {
