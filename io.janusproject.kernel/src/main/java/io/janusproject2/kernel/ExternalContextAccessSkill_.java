 ...
 */
class ExternalContextAccessSkill_ extends Skill implements ExternalContextAccess {
	...
	public void join(UUID futureContext, UUID futureContextDefaultSpaceID) {
		...
		BehaviorsAndInnerContextSkill_ imp = (BehaviorsAndInnerContextSkill_) getSkill(Behaviors.class);
