 ...
 */
interface MigrationService extends DependentService {
	 ...
	 */
	Collection<URI> findKernels(Predicate<?> condition);
	 ...
	 */
	void migrateTo(Agent agent, URI kernel);

	/** Add a listener on the migration of an agent.
	 *
	 * @param listener - listener on the migration events.
	 */
	void addSpawnServiceListener(MigrationServiceListener listener);

	/** Remove a listener on the migration of an agent.
	 *
	 * @param listener - listener on the migration events.
	 */
	void removeMigrationServiceListener(MigrationServiceListener listener);
